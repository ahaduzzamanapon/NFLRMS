...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form action="{{ route('citizen.renew', Crypt::encryptString($license->id)) }}" method="POST" id="renewal-multi-form" enctype="multipart/form-data" class="space-y-6" onsubmit="return validateStep(4);" novalidate>
        @csrf
