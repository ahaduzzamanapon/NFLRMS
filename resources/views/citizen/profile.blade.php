...
<div class="max-w-3xl space-y-5">
    ...
    <div class="flex items-center justify-between">
        ...
        @if(auth()->user()->nid)
            <span class="flex items-center space-x-1 px-2.5 py-1 rounded-full text-[9px] font-semibold uppercase border border-emerald-500/30 bg-emerald-50 text-emerald-700">
                <span>✓</span><span>Profile Complete</span>
            </span>
        @else
            <span class="flex items-center space-x-1 px-2.5 py-1 rounded-full text-[9px] font-semibold uppercase border border-amber-500/30 bg-amber-50 text-amber-700">
    ...
    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-1.5 bg-white p-2 rounded-xl border border-slate-200 shadow-sm">
            <button type="button" data-tab="personal" onclick="switchTab('personal')"
                    class="profile-tab flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-[10px] font-semibold uppercase transition-all focus:outline-none bg-gov-green text-white shadow-sm">
                <span>👤</span><span>Personal Info</span>
            </button>
            <button type="button" data-tab="address" onclick="switchTab('address')"
                    class="profile-tab flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-[10px] font-semibold uppercase transition-all focus:outline-none text-slate-500 hover:bg-slate-50">
        ...
        <div class="profile-panel bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden" id="panel-personal">
            <div class="px-5 py-3 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                <span class="text-[10px] font-semibold uppercase text-slate-900 tracking-widest">Personal Information</span>
            </div>
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2 flex items-center space-x-4 p-3 bg-slate-50 border border-slate-200 rounded-lg">
                    ...
                    <div class="space-y-1">
                        <label for="profile_photo" class="block text-[10px] font-semibold uppercase text-slate-900">Upload Profile Photo (Passport Size)</label>
                ...
                <div>
                    <label for="name" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Full Name (English)</label>
                    ...
                    @error('name')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="name_bn" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Full Name (Bengali)</label>
                    ...
                    @error('name_bn')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="father_name" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Father's Name</label>
                ...
                <div>
                    <label for="mother_name" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Mother's Name</label>
                    <input type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $user->mother_name) }}"
                           placeholder="Mother's full name"
                           class="w-full px-3.5 py-2.5 text-xs rounded-lg border border-slate-200 outline-none focus:ring-1 focus:ring-gov-green bg-white">
                </div>
                <div>
                    <label for="email" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Email Address</label>
                    ...
                    @error('email')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="nid" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">National ID (NID)</label>
                    ...
                    @error('nid')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="dob" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Date of Birth</label>
                ...
                <div>
                    <label for="phone" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Mobile Number (BD 11 Digits)</label>
                    ...
                    @error('phone')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="marital_status" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Marital Status</label>
                ...
                <div>
                    <label for="spouse_name" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Spouse Name</label>
                ...
                {{-- <div>
                    <label for="nationality" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Nationality</label>
                    <input type="text" name="nationality" id="nationality" value="{{ old('nationality', $user->nationality ?? 'Bangladeshi') }}"
                           class="w-full px-3.5 py-2.5 text-xs rounded-lg border border-slate-200 outline-none focus:ring-1 focus:ring-gov-green bg-white">
                </div> --}}
                <div>
                    <label for="religion" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Religion</label>
        ...
        <div class="profile-panel hidden bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden" id="panel-address">
            <div class="px-5 py-3 border-b border-slate-100 bg-slate-50">
                <span class="text-[10px] font-semibold uppercase text-slate-900 tracking-widest">Address Information</span>
            </div>
            <div class="p-5 space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="district_id" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">District</label>
                    ...
                    <div>
                        <label for="upazila_id" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Upazila / Thana</label>
                ...
                <div>
                    <label for="present_address" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Present Address</label>
                ...
                <div>
                    <label for="permanent_address" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Permanent Address</label>
        ...
        <div class="profile-panel hidden bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden" id="panel-education">
            <div class="px-5 py-3 border-b border-slate-100 bg-slate-50">
                <span class="text-[10px] font-semibold uppercase text-slate-900 tracking-widest">Education, Occupation & Income</span>
            </div>
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="edu_qualification" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Educational Qualification</label>
                ...
                <div>
                    <label for="occupation" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Occupation</label>
                ...
                <div class="sm:col-span-2">
                    <label for="employer_address" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Employer / Office Address</label>
                ...
                <div>
                    <label for="annual_income" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Annual Income (BDT)</label>
                    <input type="number" name="annual_income" id="annual_income" value="{{ old('annual_income', $user->annual_income) }}"
                           placeholder="e.g. 500000"
                           class="w-full px-3.5 py-2.5 text-xs rounded-lg border border-slate-200 outline-none focus:ring-1 focus:ring-gov-green bg-white">
                </div>
                <div>
                    <label for="tin_number" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">TIN Number</label>
        ...
        <div class="profile-panel hidden bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden" id="panel-security">
            <div class="px-5 py-3 border-b border-slate-100 bg-slate-50">
                <span class="text-[10px] font-semibold uppercase text-slate-900 tracking-widest">Security & Password</span>
            </div>
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="password" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">New Password</label>
                    ...
                    @error('password')<span class="text-[9px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                    <label for="password_confirmation" class="block text-[10px] font-semibold uppercase text-slate-900 mb-1.5">Confirm New Password</label>
    ...
    function switchTab(tabName) {
        ...
        document.querySelectorAll('.profile-tab').forEach(btn => {
            ...
            btn.className = isActive
                ? 'profile-tab flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-[10px] font-semibold uppercase transition-all focus:outline-none bg-gov-green text-white shadow-sm'
                : 'profile-tab flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-[10px] font-semibold uppercase transition-all focus:outline-none text-slate-500 hover:bg-slate-50';
        });
    }
