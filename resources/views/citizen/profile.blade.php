        ...
        <div class="profile-panel bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden" id="panel-personal">
            ...
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    @error('name_bn')<span class="text-[10px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                ...
                <div>
                    ...
                    @error('nid')<span class="text-[10px] text-rose-600 font-semibold mt-1 block">{{ $message }}</span>@enderror
                </div>
                <div>
                ...
                {{-- <div>
                    <label for="nationality" class="block text-[11px] font-semibold uppercase text-slate-900 mb-1.5">Nationality</label>
