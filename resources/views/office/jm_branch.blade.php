...
<div class="max-w-6xl space-y-5">
    ...
    <div>
        <h2 class="text-2xl font-black font-serif text-slate-900">JM Branch — Case Review</h2>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <table class="w-full text-left border-collapse" id="jm-apps-table">
            ...
            <tbody class="text-xs divide-y divide-slate-100">
                ...
                @empty
                <tr>
                    <td colspan="6" class="p-10 text-center text-slate-400 font-bold">No cases in JM Branch queue.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
