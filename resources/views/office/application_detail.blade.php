                                ...
                                @if(!in_array($uploadedKey, $matchedUploadedKeys) && is_array($item))
                                    ...
                                    <div class="p-3 rounded-lg border border-slate-200 bg-slate-50/70 hover:bg-white hover:shadow-sm transition-all flex items-center justify-between group">
                                        ...
                                        <div class="flex items-center space-x-1.5">
                                            ...
                                            <button type="button" onclick="openOfficeDocumentViewer('{{ addslashes($displayName) }}', '{{ $fileName }}', '{{ $fileSize }}', true)" class="px-2.5 py-1 rounded bg-gov-green hover:bg-gov-light text-white text-[10px] font-bold transition-all shadow-sm">
                                                👁️ View
                                            </button>
                                        </div>
                                    </div>
