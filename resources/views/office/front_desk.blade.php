...
<div class="max-w-6xl space-y-5">
    ...
    <div class="flex items-start justify-between">
        <div>
            <h2 class="text-2xl font-black font-serif text-slate-900">Front Desk — Application Intake</h2>
        ...
        <table class="w-full text-left border-collapse" id="apps-table">
            ...
            <tbody class="text-xs divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors app-row" data-category="{{ $category }}">
                    ...
                    <td class="p-3 font-bold {{ $ageDays >= 10 ? 'text-rose-600' : 'text-slate-600' }}">
                        {{ $ageDays }}d
                    </td>
                    <td class="p-3">
                    ...
                    <td class="p-3 pr-5 text-right">
                        <a href="{{ route('front_desk.show', $a->id) }}"
                           class="text-xs font-black text-gov-green hover:underline">
                            Open →
                        </a>
                    </td>
                </tr>
