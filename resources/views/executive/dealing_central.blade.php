...
<span class="text-[10px] font-semibold uppercase text-slate-500 tracking-widest">New Dealing Licence Applications</span>
        </div>
...
<span class="px-2 py-0.5 rounded-full text-[9px] font-semibold uppercase border
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-5 py-3 border-b border-slate-100 bg-slate-50">
<span class="text-[10px] font-semibold uppercase text-slate-500 tracking-widest">Dealing Licence Renewals</span>
        </div>
        <table class="w-full text-left border-collapse">
            <thead>
<tr class="border-b border-slate-100 text-[10px] font-semibold uppercase text-slate-400 tracking-wider bg-slate-50">
