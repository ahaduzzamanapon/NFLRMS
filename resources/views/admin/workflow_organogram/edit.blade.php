@extends('layouts.app')
@section('title', $workflow->name . ' — তথ্য সম্পাদনা')
...
<div class="w-full max-w-xl space-y-5">
    ...
    <div>
        <div class="text-xs text-slate-400 mb-1">
            ...
            <span class="mx-1">›</span>
            <span class="text-slate-600">তথ্য সম্পাদনা</span>
        </div>
        <h2 class="text-xl font-bold font-serif text-slate-900">ওয়ার্কফ্লো তথ্য সম্পাদনা</h2>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <form action="{{ route('admin.workflow_organogram.update', $encWfId) }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">Key (পরিবর্তনযোগ্য নয়)</label>
                <input type="text" value="{{ $workflow->key }}" disabled
                       class="w-full px-3 py-2 text-xs rounded-lg border border-slate-100 bg-slate-50 text-slate-400">
            </div>

            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">নাম (English) <span class="text-rose-500">*</span></label>
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">নাম (বাংলা)</label>
            ...
            <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1">বিবরণ</label>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="is_active" class="text-xs font-semibold text-slate-700 cursor-pointer">সক্রিয়</label>
            </div>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit"
                    ...
                    <i class="fa-solid fa-save mr-1"></i> সংরক্ষণ করুন
                </button>
