...
<body class="h-full font-sans antialiased text-slate-800 flex flex-col lg:flex-row">
    ...
    <div class="w-full lg:w-1/2 lg:min-h-screen bg-gradient-to-br from-[#033425] via-[#0b523a] to-[#0a6b4a] text-white p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
        <!-- Soft decorative circles -->
        <div class="absolute -top-24 -right-24 w-72 h-72 rounded-full bg-emerald-400/10 blur-3xl"></div>
        <div class="absolute -bottom-28 left-8 w-80 h-80 rounded-full bg-teal-400/10 blur-3xl"></div>

        <!-- Top: Back link -->
        <div class="relative">
            <a href="/" class="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 backdrop-blur-sm text-xs font-semibold text-white hover:bg-white/20 transition-all">
                <span class="text-amber-300">&larr;</span>
                <span>Back to home</span>
            </a>
        </div>

        <!-- Middle Content -->
        <div class="relative my-8 lg:my-10 space-y-7 lg:space-y-8 max-w-lg">
            <!-- Gov Seal + Title (same line) -->
            <div class="flex items-center space-x-5">
                <div class="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl bg-white/10 border border-white/25 backdrop-blur-md flex items-center justify-center shadow-xl shadow-emerald-950/30 flex-shrink-0">
                    <img src="https://flms.lovable.app/__l5e/assets-v1/acbf4783-ce0b-43bc-b0fd-4ba7908c84b3/govt-logo.png" alt="Government of Bangladesh" class="w-11 h-11 lg:w-14 lg:h-14 object-contain"/>
                </div>
                <h2 class="text-2xl lg:text-[2.2rem] font-extrabold font-serif leading-tight">
                    Create your <span class="text-amber-300">NFLRMS</span> account
                </h2>
            </div>
            ...
            <!-- Feature highlights (2×2 glass grid) -->
            <div class="grid grid-cols-2 gap-3 pt-1">
                <div class="p-4 rounded-2xl bg-white/8 border border-white/15 backdrop-blur-md hover:bg-white/15 hover:border-emerald-300/30 hover:-translate-y-0.5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400/30 to-teal-400/10 border border-emerald-300/25 flex items-center justify-center text-lg shadow-lg shadow-emerald-950/20">📱</div>
                    <p class="text-xs font-bold text-white mt-3">Mobile OTP</p>
                    <p class="text-[10px] text-slate-400 font-medium leading-snug mt-1">One-time password to your phone.</p>
                </div>
                <div class="p-4 rounded-2xl bg-white/8 border border-white/15 backdrop-blur-md hover:bg-white/15 hover:border-emerald-300/30 hover:-translate-y-0.5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400/30 to-teal-400/10 border border-emerald-300/25 flex items-center justify-center text-lg shadow-lg shadow-emerald-950/20">🆔</div>
                    <p class="text-xs font-bold text-white mt-3">NID Verified</p>
                    <p class="text-[10px] text-slate-400 font-medium leading-snug mt-1">Checked against national database.</p>
                </div>
                <div class="p-4 rounded-2xl bg-white/8 border border-white/15 backdrop-blur-md hover:bg-white/15 hover:border-emerald-300/30 hover:-translate-y-0.5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400/30 to-teal-400/10 border border-emerald-300/25 flex items-center justify-center text-lg shadow-lg shadow-emerald-950/20">🌐</div>
                    <p class="text-xs font-bold text-white mt-3">Bilingual</p>
                    <p class="text-[10px] text-slate-400 font-medium leading-snug mt-1">Bangla & English supported.</p>
                </div>
                <div class="p-4 rounded-2xl bg-white/8 border border-white/15 backdrop-blur-md hover:bg-white/15 hover:border-emerald-300/30 hover:-translate-y-0.5 transition-all">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400/30 to-teal-400/10 border border-emerald-300/25 flex items-center justify-center text-lg shadow-lg shadow-emerald-950/20">✍️</div>
                    <p class="text-xs font-bold text-white mt-3">eKYC</p>
                    <p class="text-[10px] text-slate-400 font-medium leading-snug mt-1">Digitally signed, legally valid.</p>
                </div>
            </div>
        </div>

        <!-- Bottom Footer -->
        <div class="relative flex items-center justify-between text-[10px] font-semibold text-slate-500 pt-2">
            <span class="flex items-center space-x-2">
                <img src="https://flms.lovable.app/__l5e/assets-v1/acbf4783-ce0b-43bc-b0fd-4ba7908c84b3/govt-logo.png" alt="" class="w-4 h-4 object-contain opacity-80"/>
                <span class="text-slate-400">Ministry of Home Affairs &bull; Government of Bangladesh</span>
            </span>
            <span class="hidden sm:inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-white/5 border border-white/10 text-emerald-300/80">
                <span class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                <span>Govt. Secure Portal</span>
            </span>
        </div>
    </div>

    <!-- Right Pane: Sign Up Form -->
    <div class="w-full lg:w-1/2 bg-slate-50 flex flex-col p-8 lg:p-12">
